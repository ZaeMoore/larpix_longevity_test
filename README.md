...
- `calculate_vddd_and_vdda.py`. This script calculates the value of the applied --vdddd and --vdda in order to achieve a desired readback voltage from the LArPix boards. The full command to power on the boards is then printed on the terminal and can be copied and pasted to avoid typos.
...
3. **Run script to collect data and perform failure tests**. 
